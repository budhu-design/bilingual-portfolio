...
export default function CheckEmailPage() {
  return (
    <div className="mx-auto max-w-md px-6 py-24 text-center sm:px-10">
      <p className="text-sm uppercase tracking-[0.3em] text-[#c8a24e]">Almost there</p>
      ...
      <p className="mt-3 text-sm text-[#f6f3ec]/60">
        ...
        then <Link href="/portal/login" className="text-[#c8a24e] underline">log in</Link>. An administrator will review
